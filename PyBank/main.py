...
budget_data_csv = os.path.join("/Users/AttiasC16/Desktop/python-challenge/PyBank/Resources/budget_data.csv")
...
text_file = os.path.join("/Users/AttiasC16/Desktop/python-challenge/PyBank/analysis/analysis.txt")
